...
@Component({
  selector: 'app-input-razon-social',
  templateUrl: './input-razon-social.component.html',
  styleUrls: ['./input-razon-social.component.scss']
})
export class InputRazonSocialComponent implements OnInit {
